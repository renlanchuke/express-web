...
# Default-Stop:         0 1 6
# Short-Description:    xAlert
# Description:          xAlert as a daemon
### END INIT INFO
#
#
# Based on:
...
NODE_PATH=""
APPLICATION_PATH="/usr/local/src/erlangshen-web/app.js"
PIDFILE="/var/run/erlangshen-web.pid"
LOGFILE="/var/log/erlangshen-web.log"
MIN_UPTIME="5000"
SPIN_SLEEP_TIME="2000"
